...
std::vector< uint32_t, allocator< uint32_t, 64 > > ig_hexa_gll_glonum;

std::vector< float, allocator< float, 64 > > rg_gll_displacement;
std::vector< float, allocator< float, 64 > > rg_gll_weight;

std::vector< float, allocator< float, 64 > > rg_gll_lagrange_deriv;
std::vector< float, allocator< float, 64 > > rg_gll_acceleration;

std::vector< float, allocator< float, 64 > > rg_hexa_gll_dxidx;
std::vector< float, allocator< float, 64 > > rg_hexa_gll_dxidy;
std::vector< float, allocator< float, 64 > > rg_hexa_gll_dxidz;
std::vector< float, allocator< float, 64 > > rg_hexa_gll_detdx;
std::vector< float, allocator< float, 64 > > rg_hexa_gll_detdy;
std::vector< float, allocator< float, 64 > > rg_hexa_gll_detdz;
std::vector< float, allocator< float, 64 > > rg_hexa_gll_dzedx;
std::vector< float, allocator< float, 64 > > rg_hexa_gll_dzedy;
std::vector< float, allocator< float, 64 > > rg_hexa_gll_dzedz;

std::vector< float, allocator< float, 64 > > rg_hexa_gll_rhovp2;
std::vector< float, allocator< float, 64 > > rg_hexa_gll_rhovs2;
std::vector< float, allocator< float, 64 > > rg_hexa_gll_jacobian_det;
